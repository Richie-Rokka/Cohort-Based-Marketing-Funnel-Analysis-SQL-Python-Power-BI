...
FROM `project-rokka.cohort_analysis.leads` l
JOIN `project-rokka.cohort_analysis.lead_stage_events` e
...
FROM `project-rokka.cohort_analysis.leads` l
LEFT JOIN `project-rokka.cohort_analysis.lead_stage_events` e
  ON l.lead_id = e.lead_id
GROUP BY cohort_month
ORDER BY cohort_month;
